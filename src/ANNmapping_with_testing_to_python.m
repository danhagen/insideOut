...
% function [output] = ANNmapping_with_testing_to_python(babPath,layers,epochLimit,genPath)
%     myVars = {'u1','du1','u2','du2',...
%                 'x1','dx1','d2x1',...
%                 'x3','dx3','d2x3',...
%                 'x5','dx5','d2x5',...
...
%                 'fT2','dfT2','d2fT2'};
%
%     %% allowing additional input (genPath) to identify path to generalization trajectories.
%     if nargin<4:
%         genPath = babPath(1:end-18); % defaulting to parent folder assuming default trial folder is of the form XXXX_XX_XX_XXXXXX/ and has 18 chars.
%     end
%
%     %% Defining Input/Output data for training
%     tempData = load(babPath + "babblingTrial_outputData.mat", myVars{:});
%
%     babblingInputData = struct;
%
%     %{
...
%     %% sinusoidal angle/ sinusoidal stiffness
%     tempData = load(...
%         genPath + "angleSin_stiffSin_outputData.mat",...
%         myVars{:}...
%     );
%     experimentalInputData.all.angleSin_stiffSin = ...
%         return_all_sensory_states(tempData);
...
%     %% step angle/ sinusoidal stiffness
%     tempData = load(...
%         genPath + "angleStep_stiffSin_outputData.mat",...
%         myVars{:}...
%     );
%     experimentalInputData.all.angleStep_stiffSin = ...
%         return_all_sensory_states(tempData);
...
%     %% sinusoidal angle/ step stiffness
%     tempData = load(...
%         genPath + "angleSin_stiffStep_outputData.mat",...
%         myVars{:}...
%     );
%     experimentalInputData.all.angleSin_stiffStep = ...
%         return_all_sensory_states(tempData);
...
%     %% step angle/ step stiffness
%     tempData = load(...
%         genPath + "angleStep_stiffStep_outputData.mat",...
%         myVars{:}...
%     );
%     experimentalInputData.all.angleStep_stiffStep = ...
%         return_all_sensory_states(tempData);
