...
class neural_network:
    def __init__(self, ANNParams, babblingParams, plantParams):
        ...
        self.numberOfNodes = ANNParams.get("Number of Nodes", 15)
        is_number(self.numberOfNodes, "Number of Nodes",
    ...
    def plot_performance(self, returnFig=True):
        assert hasattr(self,
                       "ANNOutput"), "neural_network has no attribute 'ANNOutput', please run neural_network.run_trial() before plotting."
